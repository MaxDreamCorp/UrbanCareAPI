...
{
    public class UpdateStatusToOnOrderCommandHandler : IRequestHandler<UpdateStatusToOnOrderCommand>
    {
        private readonly IEmployeeRepository _employeeRepository;

        public UpdateStatusToOnOrderCommandHandler(IEmployeeRepository employeeRepository)
        {
            _employeeRepository = employeeRepository;
        }

        public async Task Handle(UpdateStatusToOnOrderCommand request, CancellationToken cancellationToken)
        {
            ...
            await _employeeRepository.UpdateStatusByUserIdAsync(request.UserId, (int)EmployeeStatusEnum.OnOrder, cancellationToken);
        }
    }
}
