...
namespace UrbanCare.Domain.Interfaces.Repositories
{
    public interface IOrderRepository
    {
        ...
        Task<List<Order>> GetByExecutorIdAsync(int executorId, CancellationToken cancellationToken = default);
        ...
        Task AddMaterialAsync(int orderId, Material material, int quantity, CancellationToken cancellationToken = default);
