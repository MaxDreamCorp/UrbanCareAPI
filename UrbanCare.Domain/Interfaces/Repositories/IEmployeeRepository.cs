...
namespace UrbanCare.Domain.Interfaces.Repositories
{
    public interface IEmployeeRepository
    {
        ...
        Task UpdateStatusByUserIdAsync(int userId, int statusId, CancellationToken cancellationToken = default);
        ...
        Task SetExecutorWorkPaymentForOrderAsync(int executorId, int orderId, decimal payment, CancellationToken cancellationToken = default);
    }
}
